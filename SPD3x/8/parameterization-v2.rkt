...
;; produce true if los includes given string
(check-expect (contains? "UBC" empty) false)
(check-expect (contains? "UBC" (cons "McGill" empty)) false)
(check-expect (contains? "UBC" (cons "UBC" empty)) true)
(check-expect (contains? "UBC" (cons "McGill" (cons "UBC" empty))) true)
(check-expect (contains? "Mickey" (cons "McGill" (cons "UBC" empty))) false)
...
;; produce list of operation results for every number in lon
...
;;
;; produce list of filtered results from a predicate and list
